...
<form method="POST" action="">
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control" id="tanggal" name="tanggal"  value="{{ $info->tanggal }}">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name="isi" id="isi" cols="30" rows="10">{{$info->isi }}</textarea>
